...
**Note:** Only the first 3 lines of the following code are necessary to make the plot. Everything else modify the appearance and make it a bit more presentable.
