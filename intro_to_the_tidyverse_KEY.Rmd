...
This is a bit more manageable (`r nrow(pheno_data)` rows as opposed to `r nrow(ca_obs)` rows) but there are still a lot of columns that we don't necessarily need. Let's select the columns we're interested in.
